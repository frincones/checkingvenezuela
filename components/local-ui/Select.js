  ...
  (
    ...
    return createPortal(
      <div
        ...
        className={cn(
          "app-scrollbar z-[9999] flex h-96 min-w-[300px] flex-col gap-3 overflow-y-scroll rounded-lg border bg-white p-3 shadow-lg transition-[opacity,_visibility] duration-300 ease-in-out",
          className,
