...
const sidebarLinks = [
  ...
  // --- SEPARADOR: CHATBOT IA ---
  { type: "separator", title: "Chatbot IA" },
  {
  ...
  },
  {
    ...
    href: "/dashboard/chatbot/knowledge-base",
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: "Métricas",
    href: "/dashboard/chatbot/metrics",
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  // --- SEPARADOR: CMS ---
  { type: "separator", title: "Contenido" },
  {
    title: "Servicios",
  ...
  },
  {
    ...
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 12l8-4m0 0v10l-8 4m0-10L4 7m8 4v10" />
      </svg>
    ),
  },
  {
      ...
      <div className="h-full overflow-y-auto px-3 py-4">
        <ul className="space-y-1 font-medium">
          {sidebarLinks.map((link, index) => (
            link.type === "separator" ? (
              <li key={`sep-${index}`} className="pt-4 pb-2">
